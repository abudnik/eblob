...
int eblob_l2hash_lookup(struct eblob_l2hash *l2h, const struct eblob_key *key, struct eblob_ram_control *rctl, struct eblob_backend *b);
int eblob_l2hash_remove(struct eblob_l2hash *l2h, const struct eblob_key *key, struct eblob_backend *b);
...
int eblob_l2hash_upsert(struct eblob_l2hash *l2h, const struct eblob_key *key,
			const struct eblob_ram_control *rctl, int *replaced, struct eblob_backend *b);
